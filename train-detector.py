...
if __name__ == '__main__':
    ...
    parser.add_argument('-te'		,'--test-dir'		,type=str   , required=True		,help='Input data directory for testing')
    ...
    Ytest = np.empty( ( int(batch_size), int(dim/model_stride), int(dim/model_stride), int(2*4+1) ))
    ...
    for it in range(iterations):
        ...
        print('epoch', it, 'batch', it, 'train_loss:', tr_loss, 'train_acc:', tr_acc)
        print('epoch', it, 'batch', it, 'test_loss:', te_loss, 'test_acc:', te_acc)
